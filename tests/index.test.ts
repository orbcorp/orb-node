...
import { Headers } from 'orb-billing/core';
...
describe('instantiate client', () => {
  ...
  test('maxRetries option is correctly set', () => {
    const client = new Orb({ maxRetries: 1, apiKey: 'My API Key' });
...
describe('retries', () => {
  test('single retry', async () => {
    ...
    const client = new Orb({ apiKey: 'My API Key', timeout: 2000, fetch: testFetch });
