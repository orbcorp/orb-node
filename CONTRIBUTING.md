...
```bash
npm install --save git+ssh://git@github.com:orbcorp/orb-node.git
```
...
You can release to package managers by using [the `Publish NPM` GitHub action](https://www.github.com/orbcorp/orb-node/actions/workflows/publish-npm.yml). This will require a setup organization or repository secret to be set up.
