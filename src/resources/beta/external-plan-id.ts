...
export namespace ExternalPlanIDCreatePlanVersionParams {
  ...
  export namespace AddPrice {
    ...
    export interface NewPlanMinimumPrice {
      /**
       * The cadence to bill for this price on.
       */
      cadence: 'annual' | 'semi_annual' | 'monthly' | 'quarterly' | 'one_time' | 'custom';
       ...
       */
      minimum_config: NewPlanMinimumPrice.MinimumConfig;
    ...
    export namespace NewPlanMinimumPrice {
      /**
       * Configuration for minimum pricing
       */
  ...
  export interface ReplacePrice {
    ...
    price?:
      ...
      | ReplacePrice.NewPlanMinimumPrice
      | Shared.NewPlanMinimumCompositePrice
