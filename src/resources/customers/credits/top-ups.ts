...
import { TopUpModelsPage } from '../../shared';
...
export class TopUps extends APIResource {
  ...
  ): Core.APIPromise<Shared.TopUpModel> {
  ...
  list(
    ...
    options?: Core.RequestOptions,
  ): Core.PagePromise<TopUpModelsPage, Shared.TopUpModel>;
  list(
    customerId: string,
    options?: Core.RequestOptions,
  ): Core.PagePromise<TopUpModelsPage, Shared.TopUpModel>;
  list(
    ...
    return this._client.getAPIList(`/customers/${customerId}/credits/top_ups`, TopUpModelsPage, {
      query,
      ...options,
    });
  }
