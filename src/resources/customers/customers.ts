...
import { CustomerModelsPage } from '../shared';
...
import { CostListByExternalIDParams, CostListParams, Costs } from './costs';
import * as CreditsAPI from './credits/credits';
import { CreditListByExternalIDParams, CreditListParams, Credits } from './credits/credits';
...
export class Customers extends APIResource {
   ...
   */
  create(body: CustomerCreateParams, options?: Core.RequestOptions): Core.APIPromise<Shared.CustomerModel> {
  ...
  ): Core.APIPromise<Shared.CustomerModel> {
  ...
  list(
    ...
    options?: Core.RequestOptions,
  ): Core.PagePromise<CustomerModelsPage, Shared.CustomerModel>;
  list(options?: Core.RequestOptions): Core.PagePromise<CustomerModelsPage, Shared.CustomerModel>;
  list(
    ...
    return this._client.getAPIList('/customers', CustomerModelsPage, { query, ...options });
  }
   ...
   * the Customer model.
   */
  fetch(customerId: string, options?: Core.RequestOptions): Core.APIPromise<Shared.CustomerModel> {
...
export interface Customer {
   ...
   */
  tax_id: Shared.CustomerTaxIDModel | null;
...
export interface CustomerCreateParams {
  ...
  accounting_sync_configuration?: Shared.NewAccountingSyncConfigurationModel | null;
  ...
  billing_address?: Shared.AddressInputModel | null;
   ...
   * The hierarchical relationships for this customer.
   */
  hierarchy?: Shared.CustomerHierarchyConfigModel | null;
  ...
  reporting_configuration?: Shared.NewReportingConfigurationModel | null;

  shipping_address?: Shared.AddressInputModel | null;

  tax_configuration?: Shared.NewTaxConfigurationModel | null;
